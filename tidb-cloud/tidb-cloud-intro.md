...
- Your VPC
    ...
    You can connect to your TiDB cluster via private endpoint connection or VPC peering connection. Refer to [Set Up Private Endpoint Connections](https://docs.pingcap.com/tidbcloud/set-up-private-endpoint-connections) or [Set up VPC Peering Connection](https://docs.pingcap.com/tidbcloud/set-up-vpc-peering-connections) for details.
