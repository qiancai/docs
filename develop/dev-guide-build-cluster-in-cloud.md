...
4. On the **Create Resource** page, **Starter** is selected by default. Enter a name for your {{{ .starter }}} instance, select a cloud provider, and then select the region where you want to create it.
