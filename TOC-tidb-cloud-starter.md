...
- 管理集群
  - [选择您的集群计划](/tidb-cloud/select-cluster-tier.md)
  - 管理 TiDB Cloud 集群
...
- 迁移或导入数据
  ...
  - 将数据迁移到 TiDB Cloud
    - [从 TiDB 自管集群迁移到 TiDB Cloud](/tidb-cloud/migrate-from-op-tidb.md)
...
- 向量搜索 ![BETA](/media/tidb-cloud/blank_transparent_placeholder.png)
  ...
  - 自动嵌入
    ...
    - [Amazon Titan 嵌入](/tidb-cloud/vector-search-auto-embedding-amazon-titan.md)
    - [Cohere 嵌入](/tidb-cloud/vector-search-auto-embedding-cohere.md)
    - [Jina AI 嵌入](/tidb-cloud/vector-search-auto-embedding-jina-ai.md)
    - [OpenAI 嵌入](/tidb-cloud/vector-search-auto-embedding-openai.md)
    - [Gemini 嵌入](/tidb-cloud/vector-search-auto-embedding-gemini.md)
    - [HuggingFace 嵌入](/tidb-cloud/vector-search-auto-embedding-huggingface.md)
    - [NVIDIA NIM 嵌入](/tidb-cloud/vector-search-auto-embedding-nvidia-nim.md)
  - 集成
