...
- Is controllable by Hint [SET_VAR](/optimizer-hints.md#set_varvar_namevar_value): Yes
- Type: Float
- Range: `[0, 1]`
- Default value: `0.8`
- This variable is used to specify the default selectivity of the TiDB optimizer. In some cases, when the optimizer cannot derive the predicate selectivity from statistics, the optimizer uses this default selectivity as a fallback value. **It is not recommended** to modify this value.
